...
public class UnityAdsActivity extends AppCompatActivity implements UnityAdManager.AdEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Unity Ads");
        initViews();
        adManager = new UnityAdManager(getApplicationContext(), this);
        setupButtons();
    ...
    private void initViews() {
        ...
        ((TextView) findViewById(R.id.tv_sdk_title)).setText("Unity Ads");
